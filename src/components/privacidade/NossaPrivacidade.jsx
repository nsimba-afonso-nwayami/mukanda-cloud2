        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative hidden lg:flex justify-center">
            <div className="relative w-full max-w-md">
              {/* Card principal */}
              <div className="bg-slate-900/90 backdrop-blur-md border border-blue-900/50 rounded-3xl p-6 sm:p-8 shadow-2xl shadow-cyan-950/20">
                {/* Cabeçalho */}
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-11 h-11 rounded-xl bg-cyan-500 flex items-center justify-center text-slate-950">
                ...
                {/* Linha */}
                <div className="h-px bg-blue-900/40 my-6 sm:my-8" />

                {/* Elementos */}
                <div className="space-y-4">
                  <div className="flex items-center gap-4 p-4 rounded-xl bg-slate-950/70 border border-blue-900/30">
                    <div className="w-11 h-11 shrink-0 rounded-xl bg-cyan-500/10 flex items-center justify-center text-cyan-500">
