          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-16">
            {steps.map((step, index) => (
              <div key={index} className="relative text-center">
                {/* Ícone */}
                <div className="relative mx-auto w-32 h-32 rounded-full bg-slate-950 border border-blue-700/50 flex items-center justify-center">
                  <div className="w-20 h-20 rounded-2xl bg-cyan-500/10 border border-cyan-500/30 flex items-center justify-center text-cyan-500 text-2xl">
                ...
                <p className="mt-4 text-slate-400 leading-relaxed max-w-sm mx-auto">
                  {step.description}
                </p>
              </div>
            ))}
